...
namespace HabsForum.Controllers
{
    public class CommentsController : Controller
    {
        ...
        // -------------------------------------------------------------------
        // Trello says to remove this section - double check later to make sure I read it correctly

        // GET: Comments
        //public async Task<IActionResult> Index()
        //{
        //    var habsForumContext = _context.Comment.Include(c => c.Discussion);
        //    return View(await habsForumContext.ToListAsync());
        //}
